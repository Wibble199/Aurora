...
namespace Aurora.Settings
{
    ...
    public class VariableRegistry : ICloneable //Might want to implement something like IEnumerable here
    {
        ...
        public object Clone()
        {
            string json = JsonConvert.SerializeObject(this, Formatting.None, JSONUtils.SerializerSettings);
            return JsonConvert.DeserializeObject(json, this.GetType(), JSONUtils.SerializerSettings);
        }
    }
}
